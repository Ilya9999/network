...
//Респонс - это общий ответ для всех запросов , для дженериков используем значения по умолчанию потому , что это самые распространенные значсения , они немного отличаются только в логине 
